...
function Eventpage() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8005/SpringMVC/event/eventLocations')
            .then((response) => {
    ...
    useEffect(() => {
        let apiUrl = 'http://localhost:8005/SpringMVC/event/regularEvents';

        if (selectedLocation) {
            apiUrl = `http://localhost:8005/SpringMVC/event/regularEventsSearchLocation?location=${selectedLocation}`;
